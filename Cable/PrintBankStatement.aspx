<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintBankStatement.aspx.cs" Inherits="PrintBankStatement" %>
...
<body style="font-size:11px; font-family :verdana; " onbeforeunload="unl()">
 ...
 <td width="140px" align="left"><%--TIN#:--%> <asp:label ID="lblTNGST" runat="server"></asp:label></td>
  ...
  <tr>
  <td colspan="3"><br /><h5>Bank Statement From <asp:Label ID="lblStartDate" runat="server"> </asp:Label> To <asp:Label ID="lblEndDate" runat="server"> </asp:Label></h5> </td>
  
  </tr>
  </table>  
        <br />
        <wc:ReportGridView runat="server" BorderWidth="1" ID="gvBank" 
                     AutoGenerateColumns="false" PrintPageSize="23" AllowPrintPaging="true" 
                Width="600px"  style="font-family:Verdana; font-size:11px;  " onrowdatabound="gvBank_RowDataBound">
                <PageHeaderTemplate>
                <br />
        ...
        <tr>
        <td width="460px" align="right" ><b>Difference :</b></td>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintLedgerReport.aspx.cs" Inherits="PrintLedgerReport" %>
...
<body style="font-size:11px; font-family :verdana; " onbeforeunload="unl()">
 ...
 <td width="140px" align="left"><%--TIN#:--%> <asp:label ID="lblTNGST" runat="server"></asp:label></td>
  ...
  <tr>
  <td colspan="3"><br /><h5>Ledger Of <asp:Label ID="lblLedger" runat="server"></asp:Label> <br /> Date From <asp:Label ID="lblStartDate" runat="server"> </asp:Label> To <asp:Label ID="lblEndDate" runat="server"> </asp:Label></h5> </td>
        ...
        <wc:ReportGridView runat="server" BorderWidth="1" ID="gvLedger" GridLines="None"  
                ...
                Width="600px"  style="font-family:Verdana; font-size:11px;  " onrowdatabound="gvLedger_RowDataBound">
                <PageHeaderTemplate>
                <br />
        ...
        <br />
        <table width="600" border="0" cellpadding="0" cellspacing="2"  style="font-family:Verdana; font-size:11px;  ">
         <tr>
        
     
        
        <td width="460px" align="right" ><b>Opening Balance :</b></td>
        <td width="140px" align="right"><hr /><asp:Label ID="lblOBDR" runat="server"></asp:Label><hr /></td>
          <td width="140px" align="right"><hr /><asp:Label ID="lblOBCR" runat="server"></asp:Label><hr /></td>
        </tr>
        <tr>
        
     
        
        <td width="460px" align="right" ><b>Total :</b></td>
        <td width="140px" align="right"><hr /><asp:Label ID="lblDebitSum" runat="server"></asp:Label><hr /></td>
          <td width="140px" align="right"><hr /><asp:Label ID="lblCreditSum" runat="server"></asp:Label><hr /></td>
        </tr>
        <tr>
        <td width="460px" align="right" ><b>Current Balance :</b></td>
        <td width="140px" align="right"><hr /><asp:Label ID="lblDebitDiff" runat="server"></asp:Label><hr /></td>
          <td width="140px" align="right"><hr /><asp:Label ID="lblCreditDiff" runat="server"></asp:Label><hr /></td>
        </tr>
         <tr>
        <td width="460px" align="right" ><b>Closing Balance :</b></td>
        <td width="140px" align="right"><hr /><asp:Label ID="lblClosDr" runat="server"></asp:Label><hr /></td>
          <td width="140px" align="right"><hr /><asp:Label ID="lblClosCr" runat="server"></asp:Label><hr /></td>
        </tr>
        </table>
       <br /><br />

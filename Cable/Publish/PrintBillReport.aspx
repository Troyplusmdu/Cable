<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintBillReport.aspx.cs" Inherits="PrintBillReport" %>
...
<body style="font-size:11px; font-family :verdana; ">
  ...
  <tr>
  <td colspan="3"><br /><h5>Bill Details Report :&nbsp; From <asp:Label ID="lblStartDate" runat="server"> </asp:Label> &nbsp;To <asp:Label ID="lblEndDate" runat="server"> </asp:Label></h5> </td>
  
  </tr>
  </table>  
        <br />
        <wc:ReportGridView runat="server" BorderWidth="1" ID="gvBillDetails" 
                     AutoGenerateColumns="false" PrintPageSize="23" AllowPrintPaging="true" 
                Width="600px" onrowdatabound="gvBillDetails_RowDataBound" style="font-family:Verdana; font-size:11px;  ">
                <PageHeaderTemplate>
                <br />
        ...
        <td width="460px" align="right" ><b>Total Amount :</b></td>
        <td width="140px" align="right"><hr /><asp:Label ID="lblAmount" runat="server"></asp:Label><hr /></td>
        </tr>
        </table>
       <br /><br />

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintOutstandingLedgerReport.aspx.cs" Inherits="PrintOutstandingLedgerReport" %>
...
<body style="font-size:11px; font-family :verdana; " onbeforeunload="unl()">
 ...
 <asp:HiddenField ID="hdToDelete" Value="" runat="server" /><br /><br />
 ...
 <td width="140px" align="left"><%--TIN#:--%> <asp:label ID="lblTNGST" runat="server"></asp:label></td>
  ...
  <tr>
  <td colspan="3"><br /><h5>Outstanding Report For <asp:Label ID="lblSundry" runat="server"></asp:Label>  </td>
  
  </tr>
  </table>  
        <br />
           <wc:ReportGridView runat="server" BorderWidth="1" ID="gvLedger" GridLines="None" HeaderStyle-HorizontalAlign="Left"   
                     AutoGenerateColumns="false" PrintPageSize="47" AllowPrintPaging="true" 
                Width="600"  style="font-family:Verdana; font-size:11px;  " onrowdatabound="gvLedger_RowDataBound">
                <PageHeaderTemplate>
                <br />
        ...
        <td width="460px" align="right" ><b></b></td>

...
public partial class Login : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            {
                if (company.Name != "LocalSqlServer" && company.Name  != "" && company.ProviderName != "")
    ...
    private void DemoLogin()
    {
        ...
        else
        {
            ...
            ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "alert('Invalid entry. Please check the username and password. Please try again.');", true);
        }
    }
    ...
    protected void btnLogin_Click(object sender, EventArgs e)
    {
        ...
        if (isAuthenticated == true)
        {
            ...
            LoadSMSSettings();
            IsSMSRequired();
            Session["LoggedInUser"] = txtLogin.Text;
            //FormsAuthentication.RedirectFromLoginPage(txtLogin.Text, false);
    ...
    private void IsSMSRequired()
    {
        ...
        foreach (DataRow dr in ds.Tables[0].Rows)
        {
            ...
            if (code.ToUpper() == Session["Company"].ToString())
            {
    ...
    private void LoadAppSettings()
    {
        ...
        DataSet ds = bl.GetAppSettings(Session["Company"].ToString());
    ...
    private void LoadSMSSettings()
    {
        try
        {
            ...
            if (ds != null)
            {
                ...
                {
                    Session["SMSRequired"] = null;
                    Session["CopyRequired"] = null;
                    Session["Mobile"] = null;
                }
            }
            else
